...
core.buildType = prov(() => {
    return new JavaAdapter(CoreBlock.CoreBuild, {
        ...
        draw() {
            ...
            Draw.blend();
            Draw.color();
            Draw.rect(Core.atlas.find("creator-coree1"), this.x, this.y, 90 - Time.time * 2);
            Draw.rect(Core.atlas.find("creator-coree2"), this.x, this.y, 45 + Time.time * 2);
            Draw.rect(Core.atlas.find("creator-coree3"), this.x, this.y, 90 - Time.time * 1);
