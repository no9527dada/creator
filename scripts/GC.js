...
qianqiang.buildVisibility = BuildVisibility.sandboxOnly,
    qianqiang.health = 20000; qianqiang.group = BlockGroup.none
qianqiang.size = 1;
...
qianQW5.buildVisibility = BuildVisibility.sandboxOnly,
    qianQW5.health = 20000; qianQW5.group = BlockGroup.none
qianQW5.size = 1;
...
qianQW6.buildVisibility = BuildVisibility.sandboxOnly,
    qianQW6.health = 20000; qianQW6.group = BlockGroup.none
qianQW6.size = 1;
...
qianQW7.buildVisibility = BuildVisibility.sandboxOnly,
    qianQW7.health = 20000; qianQW7.group = BlockGroup.none
qianQW7.size = 1;
...
qianQW4.buildVisibility = BuildVisibility.sandboxOnly,
    qianQW4.health = 20000; qianQW4.group = BlockGroup.none
qianQW4.size = 1;
...
qianQW9.buildVisibility = BuildVisibility.sandboxOnly,
    qianQW9.health = 20000; qianQW9.group = BlockGroup.none
qianQW9.size = 1;
...
qianQW8.buildVisibility = BuildVisibility.sandboxOnly,
    qianQW8.health = 20000; qianQW8.group = BlockGroup.none
qianQW8.size = 1;
...
qianQW11.buildVisibility = BuildVisibility.sandboxOnly,
    qianQW11.health = 20000; qianQW11.group = BlockGroup.none
qianQW11.size = 1;
...
qianQW12.buildVisibility = BuildVisibility.sandboxOnly,
    qianQW12.health = 20000; qianQW12.group = BlockGroup.none
qianQW12.size = 1;
...
qianQW13.buildVisibility = BuildVisibility.sandboxOnly,
    qianQW13.health = 20000; qianQW13.group = BlockGroup.none
qianQW13.size = 1;
...
qianQW14.buildVisibility = BuildVisibility.sandboxOnly,
    qianQW14.health = 20000; qianQW14.group = BlockGroup.none
qianQW14.size = 1;
...
qianQW15.buildVisibility = BuildVisibility.sandboxOnly,
    qianQW15.health = 20000; qianQW15.group = BlockGroup.none
qianQW15.size = 1;
...
qianQW16.buildVisibility = BuildVisibility.sandboxOnly,
    qianQW16.health = 20000; qianQW16.group = BlockGroup.none
qianQW16.size = 1;
...
qianQW17.buildVisibility = BuildVisibility.sandboxOnly,
    qianQW17.health = 20000; qianQW17.group = BlockGroup.none
qianQW17.size = 1;
...
qianQW18.buildVisibility = BuildVisibility.sandboxOnly,
    qianQW18.health = 20000; qianQW18.group = BlockGroup.none
qianQW18.size = 1;
...
qianQW19.buildVisibility = BuildVisibility.sandboxOnly,
    qianQW19.health = 20000; qianQW19.group = BlockGroup.none
qianQW19.size = 1;
...
qianQW191.buildVisibility = BuildVisibility.sandboxOnly,
    qianQW191.health = 20000; qianQW191.group = BlockGroup.none
qianQW191.size = 1;
...
const cheshiqiang = extend(Wall, "cheshiqiang", { isPlaceable() { return lib.techDsAvailable() && this.super$isPlaceable(); }, });
...
Blocks.coreShard.requirements = ItemStack.with();//小核心建造材料
...
Blocks.meltdown.powerUse = 25; Blocks.meltdown.shootDuration = 260;//熔毁炮
...
conveyor10.health = 80; conveyor10.displayedSpeed = 1.5;
...
conveyor11.health = 220; conveyor11.displayedSpeed = 30;
...
conveyor12.health = 220; conveyor12.displayedSpeed = 30;
...
lib.addToResearch(nengliangta2, { parent: nengliangta.name, });
...
lib.addToResearch(shiyoufadianji, { parent: Blocks.differentialGenerator.name, });
...
lib.addToResearch(yanjiangfadianji, { parent: Blocks.differentialGenerator.name, });
...
shiyou.consumes.liquid(Liquids.water, 1.5);
...
jiweijinggongchang1.buildType = prov(() => {
    return new JavaAdapter(GenericSmelter.SmelterBuild, {
        draw() {
            ...
            Draw.rect(Core.atlas.find("creator-c-1jiweijinggongchang-2"), this.x, this.y, 90 - Time.time * 2);
            // Draw.rect(Core.atlas.find("creator-coree4"), this.x, this.y, 45 + Time.time * 1);
        },
    }, jiweijinggongchang1);
});
...
lib.addToResearch(jiweijinggongchang1, {
    parent: zijinggongchang.name, objectives: Seq.with(
...
jiweijinggongchang2.buildType = prov(() => {
    return new JavaAdapter(GenericSmelter.SmelterBuild, {
        draw() {
            ...
            Draw.rect(Core.atlas.find("creator-c-2jiweijinggongchang-2"), this.x, this.y, 90 - Time.time * 2);
            Draw.rect(Core.atlas.find("creator-c-2jiweijinggongchang-3"), this.x, this.y, 90 - this.totalProgress * 5);
...
lib.addToResearch(weijing4GC, { parent: jiweijinggongchang3.name, });
...
jiweijinggongchang5.buildType = prov(() => {
    return new JavaAdapter(GenericSmelter.SmelterBuild, {
        draw() {
            ...
            Draw.rect(Core.atlas.find("creator-c-5jiweijinggongchang-2"), this.x, this.y, 90 - Time.time * 2);
            Draw.rect(Core.atlas.find("creator-c-5jiweijinggongchang-3"), this.x, this.y, 90 + Time.time * 3);
            Draw.rect(Core.atlas.find("creator-c-5jiweijinggongchang-4"), this.x, this.y, 45 - Time.time * 3);
...
lib.addToResearch(jiweijinggongchang5, { parent: weijing4GC.name, });
...
lib.addToResearch(weijingfenjieji, { parent: weijing4GC.name, });
...
//-----------------------------------------------------------
const { liziduizhuangji } = require('all/draw2');//粒子对撞机
...
lib.addToResearch(jizhuangxieqi0, { parent: Blocks.unloader.name, });
...
lib.addToResearch(jizhuangxieqi2, { parent: jizhuangxieqi0.name, });
...
lib.addToResearch(tanbanyasuoji2, {
    parent: zuanjingjiagongchang.name, objectives: Seq.with(
        //new Objectives.Research(SectorPresets.planetaryTerminal),//研究解锁
        //new Objectives.SectorComplete(GNoeMaps15),//占领解锁
    ),
});
