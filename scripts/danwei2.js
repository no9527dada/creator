...
const { ionBurningEffect1 } = require('floor');
...
T6sixing.abilities.add(exports.LightningFieldAbility(54, 90, 192, color, 22));
//-----------------------------------------------------------------------------------
//-----------------------------------------------------------------------------------
//T6版天蝎
...
T6tianxie.weapons.add(
    (() => {
        const w = new Weapon("creator-T6tianxie1");
        w.x = 0;
        w.y = -25;
        w.inaccuracy = 25
        w.reload = 200;//射速
...
T6tianxie.weapons.add(
    (() => {
        const w = new Weapon("creator-T6tianxie2");
        w.x = 20;
        w.y = 30;
        w.rotate = false;
        w.mirror = false;//镜像
...
T6tianxie.weapons.add(
    (() => {
        const w = new Weapon("creator-T6tianxie3");
        w.x = -20;
        w.y = 30;
        w.rotateSpeed = 2
        w.rotate = false;
...
T6tianxie.weapons.add(
    (() => {
        const w = new Weapon("creator-T6tianxie4");
        w.x = 0;
        w.y = 0;
        w.rotate = true;
        w.mirror = false;//镜像
...
T6wangzuo.weapons.add(
    (() => {
        const w = new Weapon("creator-T6wangzuo1");//喷火器
        w.x = 0;
        w.y = 27;
...
T6wangzuo.weapons.add(
    (() => {
        const w = new Weapon("creator-T6wangzuo2");
        w.x = 14;
        w.y = -5;
        w.reload = 90;
        w.recoil = 8
...
T6wangzuo.weapons.add(
    (() => {
        const w = new Weapon("creator-T6wangzuo3");
        w.top = false;
        w.mirror = false;//镜像
        w.y = -10;
        w.x = 35;
...
T6wangzuo.weapons.add(
    (() => {
        const w = new Weapon("creator-T6wangzuo4");
        w.top = false;
        w.mirror = false;//镜像
        w.y = -10;
        w.x = -35;
