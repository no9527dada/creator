...
const blockType = extendContent(StorageBlock, "KongJianQiao1", {
    ...
    load() {
        this.super$load();
        topRegion = lib.loadRegion("KongJianQiao1-top");
        bottomRegion = lib.loadRegion("KongJianQiao1-bottom");
        rotatorRegion = lib.loadRegion("KongJianQiao1-rotator");
    },
    setBars() {
        this.super$setBars();
...
const {zhiqu3} = require('GC');
lib.addToResearch(blockType, {
    parent: zhiqu3.name,
