...
/* const xingqiu = new Planet("xingqiu",Planets.sun, 1);
xingqiu.generator = new SerpuloPlanetGenerator();
// xingqiu.Planet.meshLoader = () => new HexMesh(this, 6);
// xingqiu.Planet.cloudMeshLoader = () => new MultiMesh(
//     new HexSkyMesh(this, 11, 0.15, 0.13, 5, new Color().set(Pal.spore).mul(0.9).a(0.75), 2, 0.45, 0.9, 0.38),
//     new HexSkyMesh(this, 1, 0.6, 0.16, 5, Color.white.cpy().lerp(Pal.spore, 0.55).a(0.75), 2, 0.45, 1, 0.41)
// );
xingqiu.atmosphereColor = Color.valueOf("3c1b8f");
xingqiu.atmosphereRadIn = 0.02;
xingqiu.atmosphereRadOut = 0.3;
xingqiu.startSector = 15;
xingqiu.alwaysUnlocked = true;
//xingqiu.landCloudColor = Pal.spore.cpy().a(0.5); */
...
}, "xingqiu", Planets.sun, 1);//括号里的数字是41变星球生成的地图数量
xingqiu.generator = new SerpuloPlanetGenerator();
...
xingqiu.startSector = 12;//
xingqiu.orbitRadius = 50;////轨道半径
xingqiu.accessible = true//加入点击列表
exports.xingqiu = xingqiu;
//-----------------------------------------------------------------------------------------------------------------
/* 
const yiluo = new SectorPreset("GNoeyiluo1", xingqiu, 1);
yiluo.alwaysUnlocked = true;//默认解锁
...
const xiwang = new SectorPreset("GNoexiwang15", xingqiu, 40);
